...
public class HttpRequestProxy {
    ...
    public static <K,T> Map<K,T> httpGetforMap(String url,final Class<K> keyType,final Class<T> resultType) throws HttpProxyRequestException {
        return httpGetforString("default",url, (String) null, (String) null, (Map) null, new BaseURLResponseHandler<Map<K,T> >() {
            ...
            @Override
            public Map<K,T>  handleResponse(final ClassicHttpResponse response)
                    throws IOException, ParseException {
    ...
    public static <T> Set<T> httpGetforSet(String url,final Class<T> resultType) throws HttpProxyRequestException {
        return httpGetforString("default",url, (String) null, (String) null, (Map) null, new BaseURLResponseHandler<Set<T>>() {
            ...
            @Override
            public Set<T> handleResponse(final ClassicHttpResponse response)
                    throws IOException, ParseException {
    ...
    public static <D,T> D httpGetforTypeObject(String poolName,String url,final Class<D> containType,final Class<T> resultType) throws HttpProxyRequestException {
        return httpGetforString(  poolName,url, (String) null, (String) null, (Map) null, new BaseURLResponseHandler<D>() {
            ...
            @Override
            public D handleResponse(final ClassicHttpResponse response)
                    throws IOException, ParseException {
    ...
    public static <T> T httpGet(String poolname, String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
...
//        return httpGetforString(poolname, url, (String) null, (String) null, (Map)null);
    ...
    public static <T> T httpGetforString(String poolname, String url, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        return httpGetforString(poolname, url, (String) null, (String) null, headers,responseHandler);
    }

    public static <T> T httpGetforString( String url, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        return httpGetforString("default",  url, (String) null, (String) null, headers,responseHandler);
    }
     ...
     */
    public static <T> T httpGetforString(String poolname, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
       return httpGet(  poolname,   url,   cookie,   userAgent,  (Map)null, headers, responseHandler);
    }

    public static <T> T httpGetforString(ClientConfiguration clientConfiguration, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpGetforString(String poolname, String url, String cookie, String userAgent,Object params, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
   ...
   /**
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpGet(String poolname, String url, final String cookie,final  String userAgent,final  Object params,final  Map headers,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        //拼接get请求参数
...
//                                httpGet.releaseConnection();
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpGet(ClientConfiguration clientConfiguration, String url, final String cookie,final  String userAgent,final  Object params,final  Map headers,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        //拼接get请求参数
        url = HttpParamsHandler.appendParams(url,params);
...
//                                httpGet.releaseConnection();
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpHead(String poolname, String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpHead(String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpHead(String poolname, String url,Object params,Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpHead(String poolname, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        ...
        return _handleRequest( poolname, url ,
                responseHandler,new ExecuteRequest(){
                    ...
                    public Object execute(ClientConfiguration config, HttpClient httpClient,String url, int triesCount) throws Exception {
                        ...
                        try {
                            httpHead = HttpRequestUtil.getHttpHead(config, url, cookie, userAgent, headers,params);
...
//                                httpHead.releaseConnection();
    ...
    public static <T> T httpPostWithParams(String url, Object params,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
    ...
    public static <T> List<T> httpPostForListWithParams(String url, Object params, final Class<T> resultType) throws HttpProxyRequestException {
        return httpPostforString(url, params, (Map) null, new BaseURLResponseHandler<List<T>>() {
            @Override
            public List<T>  handleResponse(ClassicHttpResponse response) throws IOException, ParseException {
                return ResponseUtil.handleListResponse(url,response,resultType);
            }
        });
    }
    public static <T> Set<T> httpPostForSet(String url, Object params, final Class<T> resultType) throws HttpProxyRequestException {
        return httpPostforString(url, params, (Map) null, new BaseURLResponseHandler<Set<T>>() {
            @Override
            public Set<T>  handleResponse(ClassicHttpResponse response) throws IOException, ParseException {
                return ResponseUtil.handleSetResponse(url,response,resultType);
            }
        });
    }
    ...
    public static <K,T> Map<K,T> httpPostForMap(String url, Object params, final Class<K> keyType, final Class<T> resultType) throws HttpProxyRequestException {
        return httpPostforString(url, params, (Map) null, new BaseURLResponseHandler<Map<K,T>>() {
            @Override
            public Map<K,T>  handleResponse(ClassicHttpResponse response) throws IOException, ParseException {
                return ResponseUtil.handleMapResponse(url,response,keyType,resultType);
            }
        });
    }
...
//			@Override
//			public Set<T>  handleResponse(ClassicHttpResponse response) throws IOException {
...
//			@Override
//			public Map<K,T>  handleResponse(ClassicHttpResponse response) throws IOException {
...
//		});
     ...
     * @throws HttpProxyRequestException
     */
    public static  <T> T  httpPost(String url, Object params, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPostforString(String url, Object params, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        return httpPost("default", url, (String) null, (String) null, params, (Map<String, File>) null, headers,responseHandler);
    }
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPostforString(String poolName,String url, Object params, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
...
//        return httpPostFileforString(poolname, url, (String) null, (String) null, params, (Map<String, File>) null);
    ...
    public static <T> T  httpPost(String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T  httpPost(String poolname, String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
...
//                    String error = SimpleStringUtil.exceptionToString(throwable);
	 ...
	 * @throws HttpProxyRequestException
	 */
	public static <T> T httpPost(String poolname, String url, final HttpOption httpOption,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPost(ClientConfiguration clientConfiguration, String url, final HttpOption httpOption,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        // System.out.println("post_url==> "+url);
        // String cookie = getCookie(appContext);
        // String userAgent = getUserAgent(appContext);
...
//                                httpPost.releaseConnection();
    ...
    public static <T> T httpPost(String poolname, String url, String cookie, String userAgent, Object params,
                                               Map<String, File> files, Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        ClientConfiguration config = ClientConfiguration.getClientConfiguration(poolname);
...
//        return httpPut(  "default",   url,   (String)null,   (String)null,  params,
//                ( Map<String, File> )null,   headers,new HttpClientResponseHandler<T>(){
//
//                    @Override
...
//
//                    @Override
//                    public List<T> handleResponse(ClassicHttpResponse response) throws IOException {
...
//                });
    ...
    public static <T> T httpPutforString(  String url,Object params, Map headers ,HttpClientResponseHandler<T> responseHandler ) throws HttpProxyRequestException{
        HttpOption httpOption = new HttpOption();
        httpOption.params = params;
        httpOption.headers = headers;
...
//                ( Map<String, File> )null,   headers,new StringResponseHandler());
    ...
    public static <T> T httpPutforString(String poolname,  String url,Object params, Map headers ,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException{
        HttpOption httpOption = new HttpOption();
        httpOption.params = params;
        httpOption.headers = headers;
...
//                                                    files, headers, responseHandler) ;
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPut(String url, Object params,  Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPut(String url, Object params,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
    	return httpPut( url, (String)null, (String)null, (Map)params,
    							(Map<String, File>)null, (Map)null, responseHandler) ;
    }
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPut(String url,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
     ...
     * @throws HttpProxyRequestException
     */
    public static <T> T httpPut(String poolname, String url, final HttpOption httpOption,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        // System.out.println("post_url==> "+url);
        // String cookie = getCookie(appContext);
        // String userAgent = getUserAgent(appContext);
        HttpEntity httpEntity = null;
...
//                                httpPut.releaseConnection();
    ...
    public static <T> T httpDelete( String url,Object params,Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException{
        return httpDelete(  "default",   url, (String)null,(String) null, (String) null, params,
                headers, responseHandler);

    }

    public static <T> T httpDeleteWithBody (String url,String requestBody,Object params,Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException{
        return httpDelete(  "default",   url, requestBody,(String) null, (String) null, params,
                headers, responseHandler);
    ...
    public static <T> T httpDelete( String poolname,String url,Object params,Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException{
        return httpDelete(  poolname,   url,(String)null, (String) null, (String) null, params,
                headers,responseHandler);

    }

    public static <T> T httpDelete( String poolname,String url,String requestBody,Object params,Map headers,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException{
        return httpDelete(  poolname,     url, requestBody,(String) null, (String) null, params,
                headers,responseHandler);
    ...
    public static <T> T httpDelete(String poolname, String url, String requestBody, final String cookie,final  String userAgent, Object params,
                                   final Map headers,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
                ...
                responseHandler,new ExecuteRequest(){
                    ...
                    public Object execute(ClientConfiguration config, HttpClient httpClient,String url, int triesCount) throws Exception {
                        ...
                        try {
                            ...
                            if (httpEntity != null) {
                                httpDeleteWithBody = HttpRequestUtil.getHttpDeleteWithBody(config, url, cookie, userAgent, headers,params);
                                ...
                                if(params != null) {
                                    List<NameValuePair> paramPair = HttpParamsHandler.paramsPaires(params);

                                    UrlEncodedFormEntity entity = new UrlEncodedFormEntity(paramPair, StandardCharsets.UTF_8);
...
//                                }
    ...
    public static <T> T sendJsonBody(String requestBody, String url, Map headers  ,HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
...
//                                httpPost.releaseConnection();
    ...
    private static StringBuilder trucateData(HttpClientResponseHandler responseHandler){
        if(responseHandler instanceof BaseURLResponseHandler){
            BaseURLResponseHandler baseURLResponseHandler = (BaseURLResponseHandler)responseHandler;
    ...
    private static <T> T _handleRequest(String poolname, String url,
                                   ...
                                   HttpClientResponseHandler<T> responseHandler,ExecuteRequest executeRequest) throws HttpProxyRequestException {
...
//                responseBody = httpClient.execute(httpPost, responseHandler);
    ...
    private static HttpUriRequestBase getHttpEntityEnclosingRequestBase(String action,ClientConfiguration config, String url,  Map headers) throws URISyntaxException {
        if(action.equals(HttpRequestUtil.HTTP_POST)){
            ...
            return HttpRequestUtil.getHttpHead(config, url, null, null, headers,null);
        }
...
//    }
    ...
    public static <T> T sendBody(String poolname,String requestBody, String url,final Map headers,ContentType contentType,
                                 final HttpClientResponseHandler<T> responseHandler,final String action) throws HttpProxyRequestException {
        ...
        return _handleRequest( poolname,  url ,
                responseHandler,new ExecuteRequest(){
                    ...
                    public Object execute(ClientConfiguration config, HttpClient httpClient,String url, int triesCount) throws Exception {
                        ...
                        try {
                            httpPost = (HttpUriRequestBase) getHttpEntityEnclosingRequestBase(action, config, url, headers);
                            if (httpEntity != null) {
                                httpPost.setEntity(httpEntity);
                            }
...
//        return httpPostforString(  poolName,url, params, (Map) null);
    ...
    public static <D,T> D httpPostForTypeObject(String poolName,String url, Object params, Map headers,final Class<D> containType, final Class<T> resultType) throws HttpProxyRequestException {
        ...
        return httpPost(  poolName,   url,  httpOption, new BaseURLResponseHandler<D>() {
            @Override
            public D handleResponse(ClassicHttpResponse response) throws IOException, ParseException {
                return ResponseUtil.handleResponse(url,response,containType,resultType);
            }
        });
//        return httpPostforString(  poolName,url, params, (Map) null);
...
//                return ResponseUtil.handleListResponse( url, response, resultType);
    ...
    public static <T> T putBody(String poolname,String requestBody, String url, final Map headers,ContentType contentType,final HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
...
//                                httpPost.releaseConnection();
    ...
    public static <T> T putBody(String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
    ...
    public static <T> T putJson(String requestBody, String url, Map headers, HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
        return putBody( "default", requestBody,   url,  headers,   ContentType.APPLICATION_JSON,  responseHandler) ;
    }

    public static <T> T putJson(String poolName,String requestBody, String url, Map headers, HttpClientResponseHandler<T> responseHandler) throws HttpProxyRequestException {
