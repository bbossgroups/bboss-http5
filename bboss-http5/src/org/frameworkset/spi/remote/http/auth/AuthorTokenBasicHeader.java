 ...
 * @Date 2026/4/27
 */
public class AuthorTokenBasicHeader extends BasicHeader {
    private AuthorTokenHolder authorTokenHolder;
    public AuthorTokenBasicHeader(AuthorTokenHolder authorTokenHolder ) {
        super(authorTokenHolder.getAuthorHeaderKey(), null);
