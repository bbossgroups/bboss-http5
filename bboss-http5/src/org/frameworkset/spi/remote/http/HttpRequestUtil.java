...
//        httpget.addHeader("Host", "www.bbossgroups.com");
    ...
    static void addHeaders(ClassicHttpRequest abstractHttpMessage, Map headers, long keepAlive){
        if(keepAlive  > 0L)
...
//        httpget.addHeader("Host", "www.bbossgroups.com");
    ...
    static HttpHead getHttpHead(ClientConfiguration config, String url, String cookie, String userAgent, Map headers,Object params) throws URISyntaxException {

        URI uri = HttpParamsHandler.httpParams(url, params);
...
//        httpPost.addHeader("Host", "www.bbossgroups.com");
    ...
    static HttpDeleteWithBody getHttpDeleteWithBody(ClientConfiguration config, String url, String cookie, String userAgent, Map headers,Object params) throws URISyntaxException {
        URI uri = HttpParamsHandler.httpParams(url, params);
...
//        httpDelete.addHeader("Host", "www.bbossgroups.com");
    ...
    public static <T> T httpGet(String poolname, String url, HttpClientResponseHandler<T> responseHandler) throws Exception {
        return httpGetforString(poolname, url, (String) null, (String) null, (Map) null,responseHandler);
    }

    public static <T> T httpGet(String poolname, String url,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        return httpGetforString(poolname, url, (String) null, (String) null, headers,responseHandler);
    }

    public static <T> T httpGet(String url,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
    ...
    public static <T> T httpGetforString(String poolname, String url, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        return httpGetforString(poolname, url, (String) null, (String) null, headers,responseHandler);
    }

    public static <T> T httpGetforString( String url, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        return httpGetforString("default",  url, (String) null, (String) null, headers,responseHandler);
    }
     ...
     * @throws Exception
     */
    public static <T> T httpGetforString(String poolname, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpGet(String poolname, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
...
//                httpGet.close();
     ...
     * @throws Exception
     */
    public static <T> T httpHead(String poolname, String url,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpHead(String url,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpHead(String poolname, String url,Map params,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpHead(String poolname, String url, String cookie, String userAgent, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpHead(String poolname, String url, String cookie, String userAgent,Map params, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        ...
        ClientConfiguration config = ClientConfiguration.getClientConfiguration(poolname);
            try {
                httpClient = getHttpClient(config);
                httpHead = getHttpHead(config, url, cookie, userAgent, headers,params);
...
//                    httpHead.releaseConnection();
    ...
    public static <T> T httpPost(String url, Map params,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static  <T> T  httpPost(String url, Map params, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpPostforString(String url, Map params, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        return httpPost("default", url, (String) null, (String) null, params, (Map<String, File>) null, headers,responseHandler);
    }
     ...
     * @throws Exception
     */
    public static <T> T httpPostforString(String poolName,String url, Map params, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
    ...
    public static <T> T  httpPost(String url,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T  httpPost(String poolname, String url,HttpClientResponseHandler<T> responseHandler) throws Exception {
    ...
    public static <T> T httpPost(String poolname, String url, String cookie, String userAgent, Map params,
                                               Map<String, File> files, Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
...
//            		httpPost.releaseConnection();
    ...
    public static <T> T httpPutforString(  String url,Map params, Map headers ,HttpClientResponseHandler<T> responseHandler ) throws Exception{
        return httpPut(  "default",   url,   (String)null,   (String)null,  params,
    ...
    public static <T> T httpPutforString(String poolname,  String url,Map params, Map headers ,HttpClientResponseHandler<T> responseHandler) throws Exception{
        return httpPut(  poolname,   url,   (String)null,   (String)null,  params,
                ( Map<String, File> )null,   headers,responseHandler);
    }
     ...
     * @throws Exception
     */
    public static <T> T httpPut(String url, Map params,  Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
     ...
     * @throws Exception
     */
    public static <T> T httpPut(String url, Map params,HttpClientResponseHandler<T> responseHandler) throws Exception {
    	return httpPut( url, (String)null, (String)null, (Map)params,
    							(Map<String, File>)null, (Map)null, responseHandler) ;
    }
     ...
     * @throws Exception
     */
    public static <T> T httpPut(String url,HttpClientResponseHandler<T> responseHandler) throws Exception {
...
//        } while (time < RETRY_TIME);
    ...
    public static <T> T httpDelete( String url,Map params,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception{
        return httpDelete(  "default",   url, (String)null,(String) null, (String) null, params,
                headers, responseHandler);

    }

    public static <T> T httpDeleteWithBody (String url,String requestBody,Map params,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception{
        return httpDelete(  "default",   url, requestBody,(String) null, (String) null, params,
                headers, responseHandler);
    ...
    public static <T> T httpDelete( String poolname,String url,Map params,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception{
        return httpDelete(  poolname,   url,(String)null, (String) null, (String) null, params,
                headers,responseHandler);

    }

    public static <T> T httpDelete( String poolname,String url,String requestBody,Map params,Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception{
        return httpDelete(  poolname,     url, requestBody,(String) null, (String) null, params,
                headers,responseHandler);
    ...
    public static <T> T httpDelete(String poolname, String url, String requestBody, String cookie, String userAgent, Map params,
                                                Map headers,HttpClientResponseHandler<T> responseHandler) throws Exception {
        ...
        HttpEntity httpEntity = requestBody == null?null:new StringEntity(
            ...
            try {
                ...
                if(httpEntity != null) {
                    httpDeleteWithBody = getHttpDeleteWithBody(config, url, cookie, userAgent, headers,params);
                    httpDeleteWithBody.setEntity(httpEntity);
//                    if(httpParams != null) {
//                        UrlEncodedFormEntity entity = new UrlEncodedFormEntity(httpParams, StandardCharsets.UTF_8);
//
...
//                    responseBody = httpClient.execute(httpDeleteWithBody, responseHandler);
                    ...
                    if(params != null && params.size() > 0) {
                        ...
                        for (int i = 0; it.hasNext(); i++) {
                            Entry entry = it.next();
                            httpParams.add(new BasicNameValuePair(String.valueOf(entry.getKey()), String.valueOf(entry.getValue())));
                        }
                    }
                    if(httpParams != null) {
...
//        } while (time < RETRY_TIME);
    ...
    public static <T> T sendJsonBody(String requestBody, String url, Map headers  ,HttpClientResponseHandler<T> responseHandler) throws Exception {

        return  sendBody( "default", requestBody,   url,   headers,ContentType.APPLICATION_JSON, responseHandler);
    }

    public static <T> T sendJsonBody(String poolname,String requestBody, String url, Map headers  ,HttpClientResponseHandler<T> responseHandler) throws Exception {

        return  sendBody( poolname, requestBody,   url,   headers,ContentType.APPLICATION_JSON, responseHandler);
    }
    public static <T> T sendBody(String poolname,String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler) throws Exception {
        HttpClient httpClient = null;
        HttpPost httpPost = null;
...
//            		httpPost.releaseConnection();
    ...
    private static HttpUriRequestBase getHttpEntityEnclosingRequestBase(String action,ClientConfiguration config, String url,  Map headers,Object params) throws URISyntaxException {
        if(action.equals(HTTP_POST)){
            ...
            return getHttpHead(config, url, null, null, headers,params);
        }
    ...
    public static <T> T sendBody(String poolname,String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler,String action) throws Exception {
        HttpClient httpClient = null;
        ...
        T responseBody = null;
            try {
                httpClient = getHttpClient(config);
                httpPost = (HttpUriRequestBase)getHttpEntityEnclosingRequestBase(action,config, url,headers,null);
                if (httpEntity != null) {
                    httpPost.setEntity(httpEntity);
                }
                if(responseHandler != null && responseHandler instanceof URLResponseHandler){
                ...
                final HttpClient tempHttpClient = httpClient;
                final HttpUriRequestBase tempHttpPost = httpPost;
                responseBody = _executeRequest(  config, new ExecuteRequest<T>() {
                    @Override
                    public T execute() throws Exception {
                        return tempHttpClient.execute(tempHttpPost, responseHandler);
...
//                    httpPost.releaseConnection();
    ...
    public static <T> T putBody(String poolname,String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler) throws Exception {
        HttpClient httpClient = null;
        HttpPut httpPut = null;
...
//        } while (time < RETRY_TIME);
    ...
    public static <T> T putBody(String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler) throws Exception {
    ...
    public static <T> T putJson(String poolname,String requestBody, String url, Map headers,ContentType contentType, HttpClientResponseHandler<T> responseHandler) throws Exception {
    ...
    public static <T> T putJson(String requestBody, String url, Map headers, HttpClientResponseHandler<T> responseHandler) throws Exception {
        return putBody( "default", requestBody,   url,  headers,   ContentType.APPLICATION_JSON,  responseHandler) ;
    }

    public static <T> T putJson(String poolName,String requestBody, String url, Map headers, HttpClientResponseHandler<T> responseHandler) throws Exception {
