...
public  class ServerRealmRequestKerberosUrlUtils extends BaseRequestKerberosUrlUtils {
    ...
    public HttpClientBuilder customizeHttpClient(HttpClientBuilder builder , ClientConfiguration clientConfiguration) throws Exception{
        builder.addRequestInterceptorLast(new ServerRealmKerberosHttpRequestInterceptor(this.serverRealmClientHelper));
        builder.addResponseInterceptorLast(new ServerRealmKerberosHttpResponseInterceptor(this.serverRealmClientHelper));
        return builder;
    }
