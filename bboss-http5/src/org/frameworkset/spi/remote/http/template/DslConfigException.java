...
public class DslConfigException extends RuntimeException{
     ...
     * @since 1.4
     */
    public DslConfigException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public DslConfigException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
