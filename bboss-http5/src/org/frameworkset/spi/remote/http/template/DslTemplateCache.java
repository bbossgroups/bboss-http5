...
public class DslTemplateCache {
	private static Logger logger = LoggerFactory.getLogger(DslTemplateCache.class);
	...
	public DslTemplateCache(int perKeyDSLStructionCacheSize, boolean alwaysCacheDslStruction) {
	...
	public VariableHandler.URLStruction getTemplateStruction(DslInfo sqlinfo, String template)
	{
		if(sqlinfo.isTpl() )
		{
			if(this.alwaysCacheDslStruction) {
...
//				int pos = this.attributes.indexOf(",");
	...
	private VariableHandler.URLStruction _getTemplateStruction(DslInfo sqlinfo, String template)
	{
	 ...
	 * @return
	 */
	private VariableHandler.URLStruction _getVTPLTemplateStructionStopCache(DslInfo dslinfo, String dsl)
	{
	 ...
	 * @return
	 */
	private VariableHandler.URLStruction _getVTPLTemplateStructionAlwaysCache(DslInfo dslinfo, String dsl)
	{
		VariableHandler.URLStruction urlStruction = null;
		if(dslinfo.isCache()) {
			String ikey = dsl;
	...
	private void logDslStructionWarn(DslInfo dslinfo, String dsl, String okey, int maxSize, long missing){
