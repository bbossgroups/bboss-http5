 ...
 * @version 1.0
 */
public class DslSOAProviderParser extends ProviderParser {
	private static Logger logger = LoggerFactory.getLogger(DslSOAProviderParser.class);
	private ConfigHolder configHolder;
	public DslSOAProviderParser(ConfigHolder configHolder, BaseApplicationContext applicationContext, String file, LinkConfigFile linkfile) {
		super(applicationContext, file, linkfile);
		this.configHolder = configHolder;
	}

	public DslSOAProviderParser(ConfigHolder configHolder, BaseApplicationContext applicationContext) {
