 ...
 * @version 1.0
 */
public class DslTemplateV2 extends Template implements DslTemplate
{

    private DslInfo dslInfo;    
   ...
   private boolean processed;
    ...
    /** Default constructor */
    public DslTemplateV2(DslInfo dslInfo)
    {
        super();
        scopeName = "estemplate";
        this.dslInfo = dslInfo;   
         this.template = this.dslInfo.getTemplate();
        this.setName(dslInfo.getTemplateName());
    ...
    private void rechecksqlistpl()
    {
    	if(data != null)
    	{
    		...
    		if(childrens != null && childrens.length > 0)
    		{
    			...
    			if(switchcase)
    			{
    				this.dslInfo.setTpl(false);
    				 
    			}
    			else
    			{
    				this.dslInfo.setTpl(true);
    			}
    		}
